...
function javascriptLevel(list, employee) {
  return list.find((x) => x.name === employee).skillLevels.javascript;
}

console.log(
  `Chuck Taylor JS level is ${javascriptLevel(staffMembers, "Chuck Taylor")}`
);
